...
# class Node:
    ...
    # def create_branch(self, chain_index, height, base_chain):
        # # FIXME: call this create_chain() since it includes base_chain ... if we just kept track of active_chain + side_branches like tinychain than
        # # create_branch would make sense ...
